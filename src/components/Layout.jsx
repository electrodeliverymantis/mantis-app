    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", height: "100vh", fontFamily: "'DM Sans', sans-serif", background: "#f0f2f7", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          flexShrink: 0, boxShadow: "0 2px 12px #00000030"
        }}>
          <button onClick={() => setMenuMobileAbierto(!menuMobileAbierto)} style={{
            background: "#ffffff15", border: "none", borderRadius: 8,
            width: 38, height: 38, cursor: "pointer", fontSize: 18, color: "#fff",
          ...
          <div style={{ fontSize: 13, color: "#94a3b8" }}>
            {menuItems.find(i => i.id === vistaActual)?.icono}
          </div>
        </div>
        ...
        {menuMobileAbierto && (
          <div style={{
            ...
            <div style={{
              ...
              boxShadow: "4px 0 24px #00000040", zIndex: 1
            }}>
              {/* Header */}
              ...
              <nav style={{ flex: 1, padding: "12px 8px", display: "flex", flexDirection: "column", gap: 2, overflowY: "auto" }}>
                {itemsVisibles.map(item => (
                  <button key={item.id} onClick={() => handleNavegar(item.id)} style={{
                    ...
                    textAlign: "left", background: vistaActual === item.id ? "linear-gradient(90deg,#6366f1,#8b5cf6)" : "transparent",
              ...
              <div style={{ padding: "12px 16px", borderTop: "1px solid #ffffff15" }}>
                ...
                <button onClick={cerrarSesion} style={{ width: "100%", padding: "8px", borderRadius: 8, border: "1px solid #ffffff15", background: "#ffffff08", color: "#94a3b8", cursor: "pointer", fontSize: 12, fontFamily: "inherit" }}>
                  Cerrar sesión
                </button>
              </div>
            </div>
        ...
        {/* Barra navegación inferior mobile */}
        <div style={{
          ...
          {itemsVisibles.slice(0, 5).map(item => (
            <button key={item.id} onClick={() => handleNavegar(item.id)} style={{
              ...
              borderTop: vistaActual === item.id ? "2px solid #6366f1" : "2px solid transparent"
            }}>
              <span style={{ fontSize: 20 }}>{item.icono}</span>
              <span style={{ fontSize: 9, color: vistaActual === item.id ? "#6366f1" : "#94a3b8", fontWeight: vistaActual === item.id ? 700 : 400 }}>
